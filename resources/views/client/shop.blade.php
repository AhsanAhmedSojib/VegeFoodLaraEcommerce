		  ...
		  <div class="row justify-content-center">
			  <div class="col-md-10 mb-5 text-center">
				  <ul class="product-category">
					  <li><a href="/shop" class="{{(request()->is('shop')?'active':'')}}">All</a></li>
					  @foreach ($catagories as $catagory)

					  	<li><a href="/view_by_cat/{{$catagory->catagory_name}}"
							 class="{{(request()->is('view_by_cat/'.$catagory->catagory_name)?'active':'')}}">{{$catagory->catagory_name}} </a></li>
